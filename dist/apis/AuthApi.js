...
var AuthApiRequestFactory = (function (_super) {
    ...
    AuthApiRequestFactory.prototype.login = function (loginDto, _options) {
        var _a, _b, _c;
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        if (loginDto === null || loginDto === undefined) {
                            throw new baseapi_1.RequiredError("AuthApi", "login", "loginDto");
                        }
            ...
            return __generator(this, function (_q) {
                switch (_q.label) {
                    ...
                    case 2:
                        ...
                        return [4, response.body.text()];
                    case 3:
                        body = _f.apply(_e, [_h.apply(_g, [_q.sent(), contentType]), "BadRequest", ""]);
                        throw new exception_1.ApiException(400, "", body, response.headers);
                    case 4:
