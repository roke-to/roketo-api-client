...
var TokensApiRequestFactory = (function (_super) {
    ...
    TokensApiRequestFactory.prototype.findAllTokens = function (_options) {
        var _a, _b, _c;
...
var TokensApiResponseProcessor = (function () {
    ...
    TokensApiResponseProcessor.prototype.findAllTokens = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_l) {
                switch (_l.label) {
                    ...
                    case 1:
                        body = _b.apply(_a, [_d.apply(_c, [_l.sent(), contentType]), "Array<string>", ""]);
                        return [2, body];
                    case 2:
                        ...
                        return [4, response.body.text()];
                    case 3:
                        body = _f.apply(_e, [_h.apply(_g, [_l.sent(), contentType]), "Array<string>", ""]);
                        return [2, body];
                    case 4:
