...
var UsersApiRequestFactory = (function (_super) {
    ...
    UsersApiRequestFactory.prototype.resendVerificationEmail = function (accountId, _options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var _config, localVarPath, requestContext, defaultAuth;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _config = _options || this.configuration;
                        if (accountId === null || accountId === undefined) {
                            throw new baseapi_1.RequiredError("UsersApi", "resendVerificationEmail", "accountId");
                        }
                        localVarPath = '/users/{accountId}/verifyEmail'
                            .replace('{' + 'accountId' + '}', encodeURIComponent(String(accountId)));
...
var UsersApiResponseProcessor = (function () {
    ...
    UsersApiResponseProcessor.prototype.resendVerificationEmail = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            var contentType, body, _a, _b, _c, _d, _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
