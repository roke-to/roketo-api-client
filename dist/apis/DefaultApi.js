...
var DefaultApiRequestFactory = (function (_super) {
    ...
    DefaultApiRequestFactory.prototype.getHello = function (_options) {
        var _a, _b, _c;
...
var DefaultApiResponseProcessor = (function () {
    ...
    DefaultApiResponseProcessor.prototype.getHello = function (response) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_q) {
                switch (_q.label) {
                    ...
                    case 1:
                        body = _b.apply(_a, [_d.apply(_c, [_q.sent(), contentType]), "HelloResponse", ""]);
                        return [2, body];
                    case 2:
                    ...
                    case 4:
                        ...
                        return [4, response.body.text()];
                    case 5:
                        body = _k.apply(_j, [_m.apply(_l, [_q.sent(), contentType]), "HelloResponse", ""]);
                        return [2, body];
                    case 6:
